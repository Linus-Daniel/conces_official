...
export default function FAQPage() {
  ...
  return (
    <section className=" shadow bg-gradient-to-br from mt-12 mb-24">
      <div className="max-w-4xl  mx-auto p-6">
        <h1 className="text-3xl font-bold bg-clip-text text-transparent bg-gradient-to-r from-conces-blue to-gold-DEFAULT  mb-6">
            ...
            <div key={index} className="border-b last:border-b-0">
              ...
              >
                <div className="flex justify-between items-center">
                  <h2 className="text-lg font-semibold text-conces-blue">
                    {faq.question}
                  </h2>
                  <svg
