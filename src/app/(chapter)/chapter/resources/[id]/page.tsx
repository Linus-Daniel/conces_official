            ...
            <div className="flex flex-col md:flex-row md:items-start md:justify-between gap-6">
              ...
              <div className="flex-1">
                <div className="flex items-center gap-3 mb-3">
                  ...
                  {resource.featured && (
                    <span className="flex items-center px-3 py-1 rounded-full bg-gold-100 text-gold-800 text-sm font-medium">
                      <span className="w-2 h-2 mr-2 rounded-full bg-gold-DEFAULT"></span>
                      Featured
                    </span>
                  )}
                </div>

                <h1 className="text-xl md:text-2xl font-semibold text-royal-900 mb-3">
                  {resource.title}
                </h1>

                <p className="text-base md:text-lg text-royal-700">
              ...
              <button
                ...
                className="flex items-center px-4 py-2 rounded-lg border border-royal-200 bg-white text-royal-DEFAULT shadow-sm hover:bg-royal-50 transition"
              >
